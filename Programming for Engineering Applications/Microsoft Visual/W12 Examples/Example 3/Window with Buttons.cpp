...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		CreateWindow(L"Button", L"Left", WS_CHILD | WS_VISIBLE, 5, 5, 100, 30, hwnd, (HMENU)MY_BUTTON_LEFT, 0, 0);
		
		CreateWindow(L"Button", L"Right", WS_CHILD | WS_VISIBLE, 110, 5, 100, 30, hwnd, (HMENU)MY_BUTTON_RIGHT, 0, 0);
	}
	break;
	case WM_COMMAND:
	{
		...
		{
			MessageBox(hwnd, L"Right Button!", L"You pressed...", MB_OK);
		}
	}
	break;
	case WM_CLOSE:
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR params, int nCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_CLIENTEDGE, g_szClassName, L"COMP500/ENSE501", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 235, 80, NULL, NULL, hInstance, NULL);
